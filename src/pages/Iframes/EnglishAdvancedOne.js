...
const EnglishAdvancedOne = ({ navigation }) => {

    const handlePressGoBack = () => {
        navigation.navigate('PageEnglish');
    };
    const EnglishIntermediateTwo = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.buttons}>
                <TouchableOpacity style={styles.buttonJump} onPress={handlePressGoBack}>
                    <Text style={styles.buttonTextJump}>Concluir</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.buttonNext} onPress={EnglishIntermediateTwo}>
                    <Text style={styles.buttonTextNext}>Próxima aula</Text>
                </TouchableOpacity>
            </View>
...
export default EnglishAdvancedOne;