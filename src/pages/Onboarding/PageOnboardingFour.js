...
const PageOnboardingFour = ({ navigation }) => {

const handlePressJump = () => {
    navigation.navigate('PageLoginOne');
  };
const handlePressNext = () => {
    navigation.navigate('PageOnboardingFive');
  };
  ...
  return (
    ...
    <View style={styles.dotsContainer}>
      ...
      <Text style={styles.subTitle}>Veja seu desenvolvimento em tempo real! Você pode visualizar o andamento dos seus cursos e se mantenher no caminho certo para alcançar seus objetivos.</Text>
...
export default PageOnboardingFour;
