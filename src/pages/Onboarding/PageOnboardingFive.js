...
const PageOnboardingFive = ({ navigation }) => {
...
const handlePressNext = () => {
  ...
  return (
    ...
    <View style={styles.dotsContainer}>
      ...
      <Text style={styles.subTitle}>Nunca perca uma atualização importante! Receba notificações sobre novas aulas, eventos, prazos e materiais liberados, garantindo que você esteja sempre atualizado e no controle do seu aprendizado.</Text>
...
export default PageOnboardingFive;
