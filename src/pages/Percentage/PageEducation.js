...
const PageEducation = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.goBackText}>Educação</Text>
            </View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.title}>Transforme o Futuro da Educação!</Text>
                <Text style={styles.subTitle}>Clique no botão abaixo e ajude a construir um aprendizado mais inclusivo e inovador. 📚🌟</Text>
