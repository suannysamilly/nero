    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.goBackText}>Saúde</Text>
            </View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.title}>Transforme o Futuro da Saúde!</Text>
                <Text style={styles.subTitle}>Clique no botão abaixo e seja parte da mudança, promovendo um futuro mais saudável e acessível para todos. 🌟👩‍⚕️</Text>
